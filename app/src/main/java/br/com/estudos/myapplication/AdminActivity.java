...
public class AdminActivity extends AppCompatActivity {
    ...
    private EditText edtNomePizzaria, edtCodigoCupom, edtDescontoCupom;
    ...
    private void adicionarCupom() {
        ...
        if (pizzariaId == null || codigo.isEmpty() || desconto.isEmpty()) {
            Toast.makeText(this, "Preencha todos os campos!", Toast.LENGTH_SHORT).show();
            return;
        }

        Map<String, Object> cupom = new HashMap<>();
        cupom.put("codigo", codigo);
        cupom.put("desconto", desconto);

        db.collection("pizzarias").document(pizzariaId).collection("cupons").add(cupom)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(this, "Cupom adicionado!", Toast.LENGTH_SHORT).show();
